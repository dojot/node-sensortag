...
var config = require('./publisher/config.json');
...
SensorTag.discover(function(sensorTag) {
  ...
  async.series([
      ...
      function(callback) {
        if (!config.device.frequency) {
          console.log('readIrTemperature');
          sensorTag.readIrTemperature(function(error, objectTemperature, ambientTemperature) {
            publisher('{"sensorTemp": ' + objectTemperature.toFixed(1) + ',"ambientTemp": ' + ambientTemperature.toFixed(1) + '}');
